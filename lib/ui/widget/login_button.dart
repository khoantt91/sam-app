...
class LoginButton extends BaseStateFulWidget {
  final String _userName;
  final String _password;

  LoginButton(this._userName, this._password);

  @override
  _LoginButtonState createState() => _LoginButtonState();
}

class _LoginButtonState extends BaseState<LoginButton> {
  void _login() {
    BlocProvider.of<LoginBloc>(context).add(LoginButtonPress(widget._userName, widget._password));
  }

  @override
  Widget getLayout() => BlocListener<LoginBloc, LoginState>(
        listener: (context, state) {
          ...
          if (state is LoginSuccess) {
            showToast(S.of(context).common_sign_in_success);
